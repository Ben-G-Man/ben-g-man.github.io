...
export const PROJECTS: Project[] = [
    {
        id: 'tadpole',
        title: 'Starboard Ephemeral Project',
        startDate: new Date(2025, 12, 0, 0, 0, 0, 0),
        endDate: new Date(2026, 1, 0, 0, 0, 0, 0),
        thumbnail: 'projects/starboard-2.png',
        description: 'During my four month long internship at Starboard Maritime Intelligence I along with two colleagues were tasked with creating a system by which we could run secure, stable, hot-reloading ephemeral instances of the Starboard app. We leveraged GCP to handle secure hosting. I investigated, pitched, and implemented the app hot-reloading via DevSpace and implemented two iterations of a custom CLI to create and open hot-reloading in custom ephemeral instances, and as a result Starboard was able to secure a mission-critical Bastion security check.',
        tags: [ProjectTag.Kubernetes, ProjectTag.DevSpace, ProjectTag.GCP],
        sections: []
    },
    {
        id: 'orphaned-users',
        title: 'Starboard Orphaned Users',
        startDate: new Date(2025, 11, 0, 0, 0, 0, 0),
        endDate: new Date(2025, 12, 0, 0, 0, 0, 0),
        thumbnail: 'projects/starboard-1.png',
        description: 'I eagerly arrived at Starboard ahead of the other interns and quickly started sifting through open tickets for business-relevant work which sat at my skill-level. I found that Starboard super-admins had no way of managing users who had been removed from their organisation. I drafted up a solution, worked with our frontend design team to design a bespoke super-admin orphaned users page, and created a new GoLang API endpoint to perform the orphaned users search business logic, before wiring the whole thing up. We found hundreds of no-org users, and thanks to my work, were able to quickly clean up the bulk of them. My solution allowed us to solve a real-world user query while reducing the users data set by 15%, clearing bloat and keeping the database maintainable.',
        tags: [ProjectTag.Go, ProjectTag.HTML, ProjectTag.CSS, ProjectTag.TS, ProjectTag.React, ProjectTag.SQL],
        sections: []
    },
    {
        id: 'feature-flag-migration',
        title: 'Starboard Feature Flag Migration',
        startDate: new Date(2026, 1, 0, 0, 0, 0, 0),
        endDate: new Date(2026, 2, 0, 0, 0, 0, 0),
        thumbnail: 'projects/starboard-2.png',
        description: 'In the second half of my internship at Starboard, I was assigned to the platforms team, where I took on a mamoth project which entailed reproducing many of Starboards feature flags in the GoLang / GraphQL based backend from scratch. At the time Starboard had implemented every feature flag in the frontend, however for mission-critical security reasons many of these flags has to be moved to the backend. I designed architecture to securely and efficiently perform authenticated feature flag checks in the backend codebase, wrote the appropriate documentation, and finaly leveraged this architecture to successfully migrate feature flag evaluation into the backend.',
        tags: [ProjectTag.Go, ProjectTag.SQL],
        sections: []
    },
    {
        id: 'onehub',
        title: 'Trade Me OneHub',
        startDate: new Date(2024, 11, 0, 0, 0, 0, 0),
        endDate: new Date(2025, 2, 0, 0, 0, 0, 0),
        thumbnail: 'projects/onehub-1.png',
        description: 'In the summer of 2024 I had the privelage of interning at New Zealands biggest site, Trade Me. I was assigned to the property team, where I worked through the entire Agile lifecycle to improve and create features in Trade Mes OneHub. In this position I took every opportunity to get involved, leading team discussions, presenting my work, and shaping my direction in the role.',
        tags: [ProjectTag.Angular, ProjectTag.TS, ProjectTag.HTML, ProjectTag.CSS, ProjectTag.SQL],
        sections: []
    },
    {
        id: 'sam-portfolio',
        title: 'Sam Hume Portfolio',
        startDate: new Date(2026, 1, 0, 0, 0, 0, 0),
        endDate: null,
        thumbnail: 'projects/sam-portfolio-1.png',
        description: 'My most recent full-stack personal project can be seen at samhume-portfolio.space. My brother and I collaborated on this site, producing a completely bespoke Lit-driven creative showcase like no other. Many challenges were out-thought to allow the volume high-quality image servicing required.',
        tags: [ProjectTag.Commission, ProjectTag.CSS, ProjectTag.HTML, ProjectTag.TS],
        sections: []
    },
    {
        id: 'tilda-neon-sign',
    ...
    },
    {
        ...
        endDate: new Date(2025, 11, 0, 0, 0, 0, 0),
